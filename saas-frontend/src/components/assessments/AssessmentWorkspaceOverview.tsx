      ...
      <section className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        <Card>
          <CardContent className="pt-5">
            <p className="text-xs font-semibold uppercase tracking-wider text-lovable-ink-muted">Status operacional</p>
            ...
            <p className="mt-3 text-2xl font-semibold text-lovable-ink">{summary.forecast.probability_60d}%</p>
        ...
        <Card>
          <CardContent className="pt-5">
            ...
            <p className="mt-3 text-sm font-semibold text-lovable-ink">{latestAssessmentSummary}</p>
        ...
        <Card>
          <CardContent className="pt-5">
            ...
            <p className="text-xs text-lovable-ink-muted">check-ins por semana no ritmo atual</p>
          </CardContent>
        </Card>

        <Card>
          <CardContent className="pt-5">
            <p className="text-xs font-semibold uppercase tracking-wider text-lovable-ink-muted">Benchmark e meta</p>
            <p className="mt-3 text-sm font-semibold text-lovable-ink">{summary.benchmark.position_label}</p>
            <p className="mt-2 text-xs text-lovable-ink-muted">
              Meta atual: {formatGoalType(summary.goal_type)} - foco primario: {buildPrimaryActionLabel(summary)}
            </p>
          </CardContent>
        </Card>
      </section>
      ...
      <section className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
        <Card className="border-lovable-primary/20 bg-lovable-primary-soft/70">
          <CardContent className="space-y-4 pt-5">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-lovable-primary">Leitura rapida para a equipe</p>
