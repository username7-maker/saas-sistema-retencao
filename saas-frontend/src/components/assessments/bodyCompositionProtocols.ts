...
export const BODY_COMPOSITION_PROTOCOLS: BodyCompositionProtocol[] = [
  ...
  { key: "mcardle_1992_4_male_18_34", label: "Macardle (1992) 4 dobras - Homens, 18-34 anos", sex: "male", ageMin: 18, ageMax: 34, requiredFields: ["skinfold_abdominal_mm", "skinfold_suprailiac_mm", "skinfold_triceps_mm", "skinfold_thigh_mm"], supported: true, notes: "Macardle/YMCA adulto 4 dobras; resultado direto em percentual." },
  { key: "mcardle_1992_3_female_18_48", label: "Macardle (1992) 3 dobras - Mulheres, 18-48 anos", sex: "female", ageMin: 18, ageMax: 48, requiredFields: ["skinfold_abdominal_mm", "skinfold_triceps_mm", "skinfold_suprailiac_mm"], supported: true, notes: "Macardle/YMCA adulto 3 dobras; resultado direto em percentual." },
  ...
  { key: "guedes_1985_3_female_18_30", label: "Guedes (1985), 3 dobras - Mulheres, 18-30 anos", sex: "female", ageMin: 18, ageMax: 30, requiredFields: ["skinfold_subscapular_mm", "skinfold_suprailiac_mm", "skinfold_thigh_mm"], supported: true, notes: "Densidade corporal Guedes adulto 3 dobras; convertido por Siri." },
  { key: "guedes_1985_3_male_18_30", label: "Guedes (1985), 3 dobras - Homens, 18-30 anos", sex: "male", ageMin: 18, ageMax: 30, requiredFields: ["skinfold_triceps_mm", "skinfold_suprailiac_mm", "skinfold_abdominal_mm"], supported: true, notes: "Densidade corporal Guedes adulto 3 dobras; convertido por Siri." },
  { key: "petroski_1995_female_18_51", label: "Petroski (1995), Mulheres, 18-51 anos", sex: "female", ageMin: 18, ageMax: 51, requiredFields: ["skinfold_midaxillary_mm", "skinfold_suprailiac_mm", "skinfold_thigh_mm", "skinfold_calf_mm"], supported: true, notes: "Petroski feminino operacional Actuar/Afig: log10(axilar media + suprailiaca + coxa + panturrilha), convertido por Siri." },
  ...
  { key: "weltman_1988_female_obese_20_60", label: "Weltman et col. (1988), Mulheres obesas, 20-60 anos", sex: "female", ageMin: 20, ageMax: 60, requiredFields: ["waist_cm", "abdomen_cm", "weight_kg", "height_cm"], supported: true, notes: "Weltman feminino usa a media de cintura e abdomen, peso e altura; resultado direto em percentual." },
  { key: "weltman_1988_male_obese_20_60", label: "Weltman et col. (1988), Homens obesos, 20-60 anos", sex: "male", ageMin: 20, ageMax: 60, requiredFields: ["waist_cm", "abdomen_cm", "weight_kg"], supported: true, notes: "Weltman masculino usa a media de cintura e abdomen e o peso." },
