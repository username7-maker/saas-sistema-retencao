...
export const BODY_COMPOSITION_PROTOCOLS: BodyCompositionProtocol[] = [
  ...
  { key: "petroski_1995_male_18_66", label: "Petroski (1995), Homens, 18-66 anos", sex: "male", ageMin: 18, ageMax: 66, requiredFields: ["skinfold_chest_mm", "skinfold_abdominal_mm", "skinfold_thigh_mm", "skinfold_calf_mm"], supported: false },
