...
const FIELD_SPECS: FieldSpec[] = [
  ...
  { key: "fat_free_mass_kg", aliases: ["fat free mass", "fat free weight", "fat free"], sections: ["body_composition", "general"] },
  ...
  { key: "body_water_kg", aliases: ["body water", "body moisture"], sections: ["body_composition", "general"], disallow: ["%", "ratio"] },
