...
import { Button, Drawer, Input, Select, Textarea } from "../../components/ui2";
    ...
    <Drawer open={open} onClose={onClose} side="right" title="Nova tarefa">
      <form ref={formRef} onSubmit={handleSubmit} className="space-y-4 p-4">
        ...
        <div>
          ...
          <Textarea name="description" rows={4} placeholder="Deixe o contexto que o time precisa para executar bem." />
        </div>

        <div>
          <label className="mb-1 block text-xs font-medium text-lovable-ink-muted">Aluno relacionado</label>
          <Select name="member_id" defaultValue={initialMemberId ?? ""}>
