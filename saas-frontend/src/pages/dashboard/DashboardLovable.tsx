...
import { useChurnDashboard, useCommercialDashboard, useExecutiveDashboard, useOperationalDashboard, useRetentionDashboard } from "../../hooks/useDashboard";
...
import { Badge, Button, Card, CardContent, CardDescription, CardHeader, CardTitle, ChartCard } from "../../components/ui2";
...
export function DashboardLovable() {
  ...
  if (executive.isLoading || commercial.isLoading || operational.isLoading || retention.isLoading || churn.isLoading) {
      ...
      <header className="flex flex-col gap-4 rounded-2xl border border-lovable-border bg-lovable-surface p-5 shadow-lovable lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-lovable-ink-muted">
            Retencao, comercial e operacao reunidos em um painel de acao.
          </p>
        </div>
