...
export const ROUTE_ACCESS = {
  ...
  methodOs: ["owner", "manager", "receptionist", "salesperson"],
  crm: ["owner", "manager", "salesperson", "receptionist"],
  aiTriage: ["owner", "manager", "receptionist"],
  aiReviewCenter: ["owner", "manager", "receptionist", "salesperson", "trainer"],
...
const ROUTE_MATCHERS: Array<{ route: RouteAccessKey; matches: (path: string) => boolean }> = [
  ...
  { route: "methodOs", matches: (path) => path.startsWith("/method-os") },
  { route: "crm", matches: (path) => path === "/crm" },
  { route: "aiTriage", matches: (path) => path.startsWith("/ai/triage") },
  { route: "aiReviewCenter", matches: (path) => path.startsWith("/ai/review-center") },
...
export function canManageRetentionExclusions(role: Role | null | undefined): boolean {
  return role === "owner" || role === "manager";
}
