...
DASHBOARD_NAMESPACES_BY_DOMAIN: dict[str, set[str]] = {
    ...
    "leads": {"dashboard_commercial", "dashboard_action_center", "dashboard_roi"},
    "nps": {
        "dashboard_executive",
        "dashboard_retention",
        "dashboard_insight_executive",
    ...
    "tasks": {"dashboard_operational", "dashboard_action_center", "dashboard_commercial", "dashboard_retention", "dashboard_roi"},
    "outcomes": {"dashboard_action_center", "dashboard_roi"},
    "assessments": {"dashboard_action_center"},
    "financial": {
        "dashboard_executive",
        "dashboard_mrr",
        "dashboard_churn",
