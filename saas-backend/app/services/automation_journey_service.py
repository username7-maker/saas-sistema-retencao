...
TEMPLATES: tuple[JourneyTemplate, ...] = (
    JourneyTemplate(
        ...
        description="Jornada canonica D0/D1/D3/D7/D15/D30 para ativacao do aluno novo.",
        domain="onboarding",
        entry_trigger="member_joined_30d",
        steps=(
            JourneyStepTemplate("Conferir cadastro do aluno", 0, "create_task", "whatsapp", "reception", "high", "Oi {nome}, bem-vindo(a)! Confirme se conseguiu acessar o app e se ficou alguma duvida."),
            JourneyStepTemplate("Conferir montagem do treino", 1, "create_task", "in_person", "coach", "high", "Confirmar que o treino foi montado e apresentado ao aluno."),
            JourneyStepTemplate("Contato pos primeiro treino", 3, "create_task", "whatsapp", "reception", "high", "Oi {nome}, como foram seus primeiros treinos? Posso te ajudar com algum ajuste?"),
            JourneyStepTemplate("Agendar avaliacao fisica", 7, "create_task", "in_person", "coach", "medium", "Agendar ou registrar a primeira avaliacao fisica do aluno."),
            JourneyStepTemplate("Revisao tecnica de execucao", 15, "create_task", "in_person", "coach", "medium", "Revisar execucao dos exercicios e ajustar orientacoes tecnicas."),
            JourneyStepTemplate("Fechamento do onboarding", 30, "create_task", "whatsapp", "reception", "high", "Oi {nome}, fechamos seu primeiro mes. Como esta sua rotina e frequencia?"),
        ),
